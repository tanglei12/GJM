...
var dragMinWidth = 570;
var dragMinHeight = 580;
/*-------------------------- +
 拖拽函数
 +-------------------------- */
...
window.onload = window.onresize = function (){
    ...
    drag(oDrag, oTitle);
    oDrag.style.left = (document.documentElement.clientWidth - 570) / 2 + "px";
    oDrag.style.top = (document.documentElement.clientHeight - 1980) / 2 + "px";
}
