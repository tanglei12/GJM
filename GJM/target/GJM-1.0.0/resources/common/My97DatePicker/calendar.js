...
function My97DP() {
	...
	var html = '';
	html += '<div id=dpTitle>';
	html += '	<div class="navImg NavImgll"><a></a></div>';
	html += '	<div class="navImg NavImgl"><a></a></div>';
	html += '	<div style="float:left">';
	html += '		<div class="menuSel MMenu"></div>';
	html += '			<input class=yminput></div>';
	html += '			<div style="float:left">';
	html += '				<div class="menuSel YMenu"></div>';
	html += '				<input class=yminput>';
	html += '			</div>';
	html += '			<div class="navImg NavImgrr"><a></a></div>';
	html += '			<div class="navImg NavImgr"><a></a></div>';
	html += '			<div style="float:right"></div>';
	html += '		</div>';
	html += '		<div style="position:absolute;overflow:hidden"></div>';
	html += '		<div></div>';
	html += '		<div id=dpTime>';
	html += '			<div class="menuSel hhMenu"></div>';
	html += '			<div class="menuSel mmMenu"></div>';
	html += '			<div class="menuSel ssMenu"></div>';
	html += '			<table cellspacing=0 cellpadding=0 border=0>';
	html += '				<tr>';
	html += '					<td rowspan=2>';
	html += '						<span id=dpTimeStr></span>&nbsp;';
	html += '						<input class=tB maxlength=2>';
	html += '						<input value=":" class=tm readonly>';
	html += '						<input class=tE maxlength=2>';
	html += '						<input value=":" class=tm readonly>';
	html += '						<input class=tE maxlength=2>';
	html += '					</td>';
	html += '					<td>';
	html += '						<button id=dpTimeUp></button>';
	html += '					</td>';
	html += '				</tr>';
	html += '				<tr>';
	html += '					<td>';
	html += '						<button id=dpTimeDown></button>';
	html += '					</td>';
	html += '				</tr>';
	html += '			</table>';
	html += '		</div>';
	html += '		<div id=dpQS></div>';
	html += '		<div id=dpControl>';
	html += '			<input class=dpButton id=dpClearInput type=button>';
	html += '			<input class=dpButton id=dpTodayInput type=button>';
	html += '			<input class=dpButton id=dpOkInput type=button>';
	html += '		</div>';
	html += '</div>';
	$d.innerHTML = html;
