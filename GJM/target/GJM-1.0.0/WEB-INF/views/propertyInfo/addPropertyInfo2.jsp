...
function add2(){
	var html = "<div style='padding:10px;'>请输入宽带类型<input type='text' id='pz' name='pz' /></div>";
	var submit = function (v, h, f) {
		var i= 0
		$(".type-radio").each(function (){
			if($(this).val() == f.pz){
		...
		if(i == 0){
			if(f.pz != null && f.pz != ""){
			$("#addZb2").before("<label class='type-label span-checked' onclick='changeType(this)' for='type7'><span class='glyphicon glyphicon-remove-circle delete' onclick='deleteType(this);'></span>"+f.pz+"<i></i> <input type='checkbox' checked='checked' class='type-radio' name='perimeter' value='"+f.pz+"'></label>");
			}
		    return true;
		}else{
			$.jBox.tip("已有宽带类型");
	...
	$.jBox(html, { title: "宽带类型", submit: submit });
}

function addKj(){
	$(".kj").after("<tr style='max-width: 500px;'>"+
		    ...
		    "房屋户型"+
				...
				"</select>"+
				"<input type='text' class='form-control jianju'  name='PropertyInfo_Name' placeholder='最高控价'>"+
				"</div>   "+
		  	"</td>"+
		  "</tr>"
			);
...
<!-- 位置栏 -->
    ...
    <form class="form-inline" alt="First slide" action="/propertyInfo/addPropertyInfo" method="post" id="addSubmit">
    	<input type="hidden" name="token" value="${token}">
			<table border="0" style="font-size: 12px;background-color: #fff;width: 96%;min-width: 1115px;margin: 0px auto;margin-top: 20px;">
				<tr>
				  ...
				  <tr>
				    <td  style="padding-left: 60px;"><em>*</em>地址<input type="text" style="width: 240px;" class="form-control jianjuss" data-validation-engine="validate[required]" name="PropertyInfo_address" placeholder="小区地址" ></td>
				  </tr>
				  <tr>
				  ...
				  <tr style="max-width: 500px;">
				    <td style="padding-left: 60px;"><em>*</em>交通<input type="text" class="form-control jianjuss"  name="PropertyInfo_Name" placeholder="小区交通"></td>
				    <td>位置<input type="text" class="form-control jianjuss"  name="PropertyInfo_Life" placeholder="小区位置" ></td>
				    <td>环境
				    	<select class="form-control jianju" name="hi_houseT">
				  ...
				  <tr style="max-width: 500px;">
				    <td style="padding-left: 60px;"><em>*</em>主要客户<input type="text" class="form-control jianju"  name="PropertyInfo_Name" placeholder="主要客户"></td>
				    <td>活跃度<input type="text" class="form-control jianjus"  name="PropertyInfo_Life" placeholder="租房活跃度" ></td>
				  </tr>
				  ...
				  <tr style="max-width: 500px;">
				  	<td style="padding-left: 60px;" bgcolor="red" width="200px">宽带</td>
					  <td colspan="2">
							<label class="type-label" onclick="changeType(this)" for="type1">
						    	<span class="glyphicon glyphicon-remove-circle delete" onclick="deleteType(this);"></span>
								移动<i></i> 
								<input type="checkbox" class="type-radio" name="perimeter" value="移动" id="type1">
							</label>
						    <label class="type-label" onclick="changeType(this)" for="type2">
						    	<span class="glyphicon glyphicon-remove-circle delete" onclick="deleteType(this);"></span>
								联通<i></i> 
								<input type="checkbox" class="type-radio" name="perimeter" value="联通" id="type2">
							</label>
						    <label class="type-label" onclick="changeType(this)" for="type3">
						    	<span class="glyphicon glyphicon-remove-circle delete" onclick="deleteType(this);"></span>
								电信<i></i> 
								<input type="checkbox" class="type-radio" name="perimeter" value="电信" id="type3">
							</label>
							<label class="type-label" onclick="changeType(this)" for="type3">
						    	<span class="glyphicon glyphicon-remove-circle delete" onclick="deleteType(this);"></span>
								光纤<i></i> 
								<input type="checkbox" class="type-radio" name="perimeter" value="光纤" id="type3">
							</label>
							<label class="type-label" onclick="add2();" id="addZb2">
								+<i></i> 
							</label>
						</td>
				  </tr>
				  ...
				  <tr>
				   <td style="padding-left: 60px;">联系人<input type="text" class="form-control jianju"  name="PropertyInfo_Tel" placeholder="联系人" ></td>
				   <td ><em>*</em>物管电话1<input type="text" class="form-control jianju"  name="PropertyInfo_Tel" placeholder="物管电话1" ></td>
				    <td >物管电话2<input type="text" class="form-control jianju"  name="PropertyInfo_Tel" placeholder="物管电话2" ></td>
				    <td >物管名称<input type="text" class="form-control jianju"  name="PropertyInfo_Wuguan" placeholder="物管名称" ></td>
				  </tr>
				  <tr>
				  <td style="padding-left: 60px;">物管费<input type="text" class="form-control jianjus" onkeyup="this.value=this.value.replace(/^[a-z\u4E00-\u9FA5]+$/,'')" name="PropertyInfo_Cost" placeholder="物管费" ><span class="jianju">元/㎡</span></td>
				  ...
				  <tr>
				    ...
				    <td>开盘价<input type="text" class="form-control jianjus" onkeyup="this.value=this.value.replace(/^[a-z\u4E00-\u9FA5]+$/,'')" name="PropertyInfo_OpenPrice" placeholder="开盘价" ><span class="jianju">元/㎡</span></td>
				  </tr>
				  <tr>
				    <td style="padding-left: 60px;">占地面积<input type="text" onkeyup="this.value=this.value.replace(/^[a-z\u4E00-\u9FA5]+$/,'')" class="form-control jianju"  name="PropertyInfo_TotalArea" placeholder="占地面积" ><span class="jianju">万/㎡</span></td>
				    <td>建筑面积<input type="text" class="form-control jianju" onkeyup="this.value=this.value.replace(/^[a-z\u4E00-\u9FA5]+$/,'')" name="PropertyInfo_BuildArea" placeholder="建筑面积" ><span class="jianju">万/㎡</span></td>
				  ...
				  <tr>
				  	<td colspan="3" style="padding-left: 79px;"><button class="btn btn-info" style="width:70px;margin-bottom: 30px;" type="submit">添加</button></td>
				  </tr>
			</table>
	</form>
<script>
	$("input[name='PropertyInfo_Name']").focus();
	
	function validate(){
		var validate = $("input[name='PropertyInfo_Name']").val()
		$.ajax({
		    type: "POST",
		    url: "/propertyInfo/accountBools",
		    data: "validate="+validate,
		    contentType: "application/x-www-form-urlencoded; charset=utf-8",
		    dataType: "json",
		    success: function(result) {
		    		if(result.infoString == 'success'){
		    			
		    		}else{
		    			$("input[name='PropertyInfo_Name']").val("");
		    			$.jBox.tip("该小区已存在");
		    		}
		    	}
		    });
