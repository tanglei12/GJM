...
<head>
	...
	<script src="/resources/js/appPage/contractPrint_TG.js"></script>
</head>
<body>
	...
	<div id="div1" class="" style="position: relative; text-align: center; margin: 0 auto; width: 100%; margin-bottom: 20px; ">
		...
		<dl class="dl-list">
			...
			<dd>1、委托期限：<label class="textUnderLine">&nbsp;${startDateArray[0] }&nbsp;</label>年<label class="textUnderLine">&nbsp;${startDateArray[1] }&nbsp;</label>月<label class="textUnderLine">&nbsp;${startDateArray[2] }&nbsp;</label>日起至<label
					class="textUnderLine">&nbsp;${endDateArray[0] }&nbsp;</label>年<label class="textUnderLine">&nbsp;${endDateArray[1] }&nbsp;</label>月<label class="textUnderLine">&nbsp;${endDateArray[2] }&nbsp;</label>日止。
			</dd>
			...
			<dd>2、租金（乙方代付）：<label class="textUnderLine">&nbsp;${payStyle }&nbsp;</label>付，</dd>
			<dd>
				<div style="text-indent: 2em;" id="rent"><input type="hidden" value="${rentPlusStr }" id="rentPlusStr">
			...
			<dd>3、超额租金分成：甲方<label class="textUnderLine">&nbsp;${contractBody.contractBody_RentRate_A }&nbsp;</label>％，乙方<label class="textUnderLine">&nbsp;${contractBody.contractBody_RentRate_B }&nbsp;</label>％。</dd>
			<dd>4、免租期：第一年<label class="textUnderLine">&nbsp;${freeTime[0] }&nbsp;</label>天，第二年<label class="textUnderLine">&nbsp;${freeTime[1] }&nbsp;</label>天，第三年<label class="textUnderLine">&nbsp;${freeTime[2] }&nbsp;</label>天，第四年<label class="textUnderLine">&nbsp;${freeTime[3] }&nbsp;</label>天，第五年<label
					class="textUnderLine">&nbsp;${freeTime[4] }&nbsp;</label>天。
			</dd>
			<dd>5、乙方管理费：<label class="textUnderLine" id="data_7">&nbsp;¥${contractBody.contractBody_Service }&nbsp;</label>元（大写<label class="textUnderLine" id="data_8">&nbsp;&nbsp;</label>整）。</dd>
			<dd>6、首次代付租金日：每年度的免租期租金，乙方在每年度首次付租时扣除。</dd>
			<dd>
			...
			<dd>7、乙方保证金<label class="textUnderLine" id="data_5">&nbsp;¥${contractBody.contractBody_Pay }&nbsp;</label>元（大写<label class="textUnderLine" id="data_6">&nbsp;&nbsp;</label>整）。</dd>
			<dd>8、乙方定金<label class="textUnderLine" id="data_1">&nbsp;¥${contractBody.contractBody_Depslit }&nbsp;</label>元（大写<label class="textUnderLine" id="data_2">&nbsp;&nbsp;</label>整），乙方首次代付租金时减除。</dd>
			<dd>
			...
			<dd>10、税费： 甲方承担的房屋租赁税、房产税及政府规定的出租房屋征收的其他税费等，乙方协助办理。</dd>
