...
<head>
    ...
    <script src="/resources/js/appPage/service.js?v=<%=System.currentTimeMillis()%>"></script>
...
<div id="pullrefresh" class="mui-content mui-scroll-wrapper">
    <div class="mui-scroll">
        <div class="top-nav">
            <div class="nav nav4 on" id="nav4" ><span class="nav_name">全部</span></div>
            <div class="nav nav1 " id="nav1"><span class="nav_name">未接单</span></div>
