...
<script src="/resources/js/appPage/houseStatusList.js"></script>
</head>
<body>
<div class="search">
	<div class="search-text"><input type="text" name="search-content" class="search-input" placeholder="合同编号/小区地址" onkeyup="data(0)" /></div>
