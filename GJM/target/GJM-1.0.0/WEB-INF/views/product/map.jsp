...
<script>
	function myfun(){
		var address = window.parent.document.getElementById("propertyInfo_Id").value;
		...
		var hi_address = window.parent.document.getElementById('pr'+window.parent.document.getElementById("propertyInfo_Id").value).innerHTML;
	...
	function latitude(){
		...
		window.parent.document.getElementById('biaozhu').value=latitude;
