...
<script src="/resources/js/service/addHotSpot.js"></script>
<!-- 文本编辑器 -->
<script src="/resources/Plug-in/My97DatePicker4.7.2/WdatePicker.js"></script>
<script charset="utf-8" src="/resources/Plug-in/kindeditor-4.1.10/kindeditor-min.js"></script>
<script charset="utf-8" src="/resources/Plug-in/kindeditor-4.1.10/lang/zh_CN.js"></script>
<script>
var editor;
KindEditor.ready(function(K) {
    ...
    <form class="form-inline" action="/service/addHotSpot" target="iframepage" method="POST" id="addSubmit">
		<section id="main-box">
			<div class="box-title">添加热点问题</div>
			<div id="main-box-content">
				...
				<dl class="content-dl">
					<dt><em>*</em>热点问题描述</dt>
					<dd>
						<input type="text" class="from-data" required="required" name="sip_name" placeholder="热点问题">
					</dd>
					<dd class="msg"></dd>
				</dl>
				<dl class="content-dl">
					<dt><em>*</em>热点问题答案</dt>
					<dd style="width: auto;">
						<textarea name="sip_content" class="content" style="width:960px;height:400px;visibility:hidden;"></textarea>
					</dd>
					<dd class="msg"></dd>
				</dl>
				<dl class="content-dl">
