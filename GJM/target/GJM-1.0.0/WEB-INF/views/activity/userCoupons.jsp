...
<head>
    ...
    <link href="/resources/css/activity/userCoupons.css?v=<%=System.currentTimeMillis()%>" rel="stylesheet" type="text/css">
    ...
    <script src="/resources/js/activity/userCoupons.js?v=<%=System.currentTimeMillis()%>"></script>
</head>
<body>
</body>
</html>
