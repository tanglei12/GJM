...
<!-- 位置栏 -->
    ...
    <form class="form-inline" alt="First slide" action="/recommendGroup/addRecommendGroup" method="POST" id="addSubmit">
    	...
    	<div class="dfs">
			...
			<table border="0">
				  ...
				  <tr>
				  	<td colspan="2" style="padding-left: 78px;"><button class="btn btn-info" style="width:70px;margin-bottom: 30px;" type="submit">添加</button></td>
				  </tr>
			</table>
		</div>
	</form>	
