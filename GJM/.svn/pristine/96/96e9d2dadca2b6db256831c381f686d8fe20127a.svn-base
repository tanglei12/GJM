...
<title>房屋托管合同打印</title>

<script src="/resources/js/jquery-1.7.2.min.js" type="text/javascript"></script>
<script src="/resources/js/common/common.js"></script>
<script src="/resources/print/LodopFuncs.js"></script><!-- 打印插件 -->
<script src="/resources/js/appPage/contractTGPrint.js?v=1.8"></script>
...
<!-- 	<div class="contract-print-box"><a href="javascript:exportMytable();">导出</a></div> -->
