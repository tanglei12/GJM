...
<head>
    ...
    <script src="/resources/js/appPage/service/sceneServiceOld.js?v=<%=System.currentTimeMillis()%>"></script>
</head>
<body>
<div class="center">
    <dl>
        <dt>服务类型：</dt>
        <dd><input type="text" value="" readonly="readonly" id="service_title"/></dd>
    </dl>
    ...
    <div style="height: 30px; line-height: 30px; padding: 0 10px; color:#999;">维修项目</div>
    <div class="content">

    </div>
    <dl>
        <dd><input style="width: 90%;" type="text" value=""/><i class="fa-plus-square-o"
                                                                style="font-size: 20px; color: #1ABC9C;"
                                                                onclick="addServiceProject(this)"></i></dd>
    </dl>
</div>
