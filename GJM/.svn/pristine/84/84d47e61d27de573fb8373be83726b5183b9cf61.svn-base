...
<script src="/resources/js/contractList/contractZL_v2.js?v=<%=System.currentTimeMillis()%>"></script>
	...
	<div id="contractTGPrint" style="width: 950px;margin: 2px auto;background : url(/resources/image/watermark.png);">
		<div id="div1" class="" style="position: relative;text-align:center;margin: 0 auto;width: 100%; margin-bottom: 20px;">
			...
			<div>
				...
				<p class="conInfo">
					2、&nbsp;新承租人继承乙方原有责任、权利和义务。为保障新承租人利益，须新承租人入住确认无人为损坏问题后，丙方第7天与乙方办理费用结算手续，扣除相关费用后，退还乙方剩余房租和保证金等。
				</p>
				<p class="conInfo">
			...
			<div>
				...
				<p class="conInfo" style="text-indent:2em;">
					②合同期内的3-11月份,丙方验收房屋内装修\家具家电等无人为损坏,同意乙方办理退房手续,扣除乙方1个月租金和相关费用后，第7天退还乙方剩余款项。
				</p>
				<p class="conInfo" style="text-indent:2em;">
				...
				<p class="conInfo" style="text-indent:2em;">
					②合同期满退房，丙方验收房屋内装修、家具家电等无人为损坏，丙方与乙方办理结算手续，扣除相关费用后，第7天退还乙方剩余款项。
				</p>
				<p class="conInfo" style="text-indent:2em;">
