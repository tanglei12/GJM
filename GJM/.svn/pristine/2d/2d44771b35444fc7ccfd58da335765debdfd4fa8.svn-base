...
<head>
    ...
    <link href="/resources/css/collection/collectionList.css?v=<%=System.currentTimeMillis()%>" rel="stylesheet" type="text/css">
    ...
    <script src="/resources/js/collection/collectionList.js<%--?v=<%=System.currentTimeMillis()%>--%>"></script>
</head>
<body>
</body>
</html>
