...
<head>
	...
	<script src="/resources/js/appPage/contractPrint_TG2-4.js?v=<%=System.currentTimeMillis()%>"></script>
</head>
<body>
...
<div id="contractTGPrint" style="padding: 10px;background : url(/resources/image/appPage/contract/gjp_bg.png);">
	<div id="div1" class="" style="position: relative; text-align: center; margin: 0 auto; width: 100%; margin-bottom: 20px; ">
		...
		<div class="flex-list">
			<div class="flex-item"><span>乙方：</span><span class="flex-item-line"><p>重庆管家婆房地产经纪有限公司</p><p id="payYear1">${contractBody.contractBody_PayType }</p></span></div>
			<div class="flex-item"><span>营业执照号：</span><span class="flex-item-line"><p>915001085540918999</p><p id="payYear3">91510105MA6CLQBG5L</p></span></div>
		</div>
		<div class="flex-list">
		...
		<dl class="dl-list">
			...
			<dd>2、<label id="gjp1">租金（乙方代付）：</label><label id="pangu1" style="display: none;">固定租金回报（乙方定期向甲方支付的款项称为固定租金回报）：</label><input type="hidden" value="${payStyle }" id="payStyle"><%--<label class="textUnderLine">&nbsp;${payStyle }&nbsp;</label>付，--%>
			...
			<dd id="gjp2">符合条件的甲方若选择年付，即默认自愿申请与乙方合作的第三方办理房东年付金融服务，甲方可提前一次性收到当年度乙方代付租金，乙方协助甲方按年度申请，乙方按本合同约定租金还款给第三方。如当年度甲方未通过第三方审核，按本合同约定租金自动转为乙方季付给甲方。</dd>
			<dd>每年12月、1月和2月账期内租金支付双方约定自动变为月付。</dd>
			<dd>
			...
			<dd id="gjp4">超额租金分成：甲方<label class="textUnderLine">&nbsp;${contractBody.contractBody_RentRate_A }&nbsp;</label>％，乙方<label class="textUnderLine">&nbsp;${contractBody.contractBody_RentRate_B }&nbsp;</label>％。</dd>
			...
			<dd>7、<label id="gjp5">首次代付租金日：</label><label id="pangu3" style="display: none;">首次固定租金回报支付日：</label>每年度的免租期租金，乙方在每年度首次付租时扣除。</dd>
			<dd>
			...
			<div id="gjpHT">
				...
				<dd>11、税费：甲方自行办理房屋租赁税、房产税、个人所得税及政府规定的出租房屋征收的其他税费等。</dd>
				<dd>12、委托期间费用： 乙方为甲方垫付的托管前甲方未交清的水电气费、物管费、清洁费、电话费、宽带费、有线费等，包括托管期间应甲方承担的维修等费用,甲方同意乙方在支付下期租金时直接扣除。</dd>
			</div>
			<div id="panguHT">
				<dd>9、代付租金： 乙方代承租方支付租金给甲方后，甲方委托乙方向承租方催收租金，乙方扣除相关费用后，再转交给甲方。每次代付租金日根据支付方式按签合同日期顺延，3个工作日内到账，周末、节假日等顺延。</dd>
				<dd>10、税费：甲方自行办理房屋租赁税、房产税、个人所得税及政府规定的出租房屋征收的其他税费等。</dd>
				<dd>11、委托期间费用： 乙方为甲方垫付的托管前甲方未交清的水电气费、物管费、清洁费、电话费、宽带费、有线费等，包括托管期间应甲方承担的维修等费用,甲方同意乙方在支付下期租金时直接扣除。</dd>
			</div>
		</dl>
		<dl class="dl-list">
		...
		<dl class="dl-list">
			...
			<dd id="pangu4" style="display: none;">4、无论本合同因何种原因解除或终止，甲方应将合同解除或终止时剩余委托期限对应的已支付的固定租金回报款项退回至如下账户：户名：<label class="textUnderLine">&nbsp;成都有家商业管理有限公司&nbsp;</label>，开户行：<label class="textUnderLine">&nbsp;招商银行顺城大街支行&nbsp;</label>，帐号：<label class="textUnderLine">&nbsp;128907831310101&nbsp;</label>。</dd>
		</dl>
		<dl class="dl-list">
			<dt>第十一条&nbsp;&nbsp;争议解决:本合同项下发生的争议,由甲乙双方当事人协商；协商不成的,可向乙方所在地人民法院提起诉讼,诉讼费、律师费用等费用由败诉方承担。</dt>
		</dl>
		<dl class="dl-list">
			<dt id="gjpYD">第十二条&nbsp;&nbsp;本合同壹式贰份,甲乙双方各执壹份,具有同等法律效力,自双方签字（盖章）后生效。</dt>
			<dt id="panguYD">第十二条&nbsp;&nbsp;本合同壹式叁份,甲方执壹份,乙方执两份,具有同等法律效力,自双方签字（盖章）后生效。</dt>
		</dl>
		<dl class="dl-list">
		...
		<div class="flex-list">
			...
			<div class="flex-item"><span style="width: 90px;">乙方：</span><span><p>重庆管家婆房地产经纪有限公司</p><p id="payYear2">${contractBody.contractBody_PayType }</p></span></div>
		</div>
		<div class="flex-list">
