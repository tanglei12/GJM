...
<head>
	...
	<script src="/resources/js/appPage/contractPrint_ZL2-3.js?v=<%=System.currentTimeMillis()%>"></script>
</head>
<body>
...
<div id="contractTGPrint" style="padding: 10px;background : url(/resources/image/appPage/contract/gjp_bg.png);">
	<div id="div1" class="" style="position: relative;text-align:center;margin: 0 auto;width: 100%; margin-bottom: 20px;">
		...
		<dl class="dl-list">
			...
			<dd>3、因乙方原因导致第三方分期月付逾期，经第三方或丙方催告后，仍不交纳租金的。乙方承担第三方相应违约金、当期租金每天1%的滞纳金和违约责任。</dd>
			<dd>4、乙方申请第三方金融月付，因乙方原因导致合同提前解约的，乙方须支付金融公司月租金10%的违约金。</dd>
			<dd>5、未经丙方书面同意或隐瞒丙方，擅自退房、擅自转租、擅自拆改变动房屋结构、擅自装修或擅自改变房屋租赁用途。</dd>
			<dd>6、利用承租房屋进行违法活动或存放危险物品。</dd>
			<dd>7、邻居或物业累计投诉3次及以上。</dd>
			<dd>8、不依据本合同承担维修责任或支付维修费用，致使房屋装修或家具家电等设施设备严重损坏的，或在丙方提出的合理期限内仍未修复的。</dd>
		</dl>
		<dl class="dl-list">
