...
function ck(){
    ...
    if (checkCount == 0) {  
	 ...
	 window.location.href = '/serve/manage?id='+id;
 } 
}
      ...
      var logic = {
        size: {
          small: function($html){
            ...
            containerWidth = (stepCount*200+100)+"px",
          ...
          large: function($html){
            var stepCount = $html.find("li").length-1,
            containerWidth = (stepCount*300+300)+"px",
            progressWidth = (stepCount*300)+"px";
            $html.css({
              width: containerWidth
            });
            $html.find(".ystep-progress").css({
...
function revoke(){
	...
	$.ajax({
	    ...
	    success: function(result) {
	    	$(".ystep4").setStep(3);
	    	$("#start0").css("display","none");
	    	$("#start1").css("display","block");
	    	$("#up").removeClass().addClass("up1");
	    	$("#mtks").css("display","none");
	    	var ids = md_id;
	    	selectOrade(ids);
	    	selectOrades(ids);
	    }
