        ...
        for (var i = 0; i < rentArray.length; i++){
            ...
            if(payStyle == "年" && "磐谷" == returnValue($("#payYear1").text())){
                if(i < year){
                    ...
                    html += '<p class="conInfo">第 ' + (i + 1) + ' 年固定租金回报：<label class="textUnderLine">&nbsp;' + returnNumber(rentArray[i]) + '&nbsp;</label>元/月（年固定租金回报：<label class="textUnderLine">&nbsp;' + money.substr(0, money.indexOf("元整")) + '&nbsp;</label>元整）。</p>';
                } else {
