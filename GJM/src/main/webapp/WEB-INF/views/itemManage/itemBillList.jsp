...
<script src="/resources/js/itemsManage/ListItemsBill.js"></script>
	        	...
	        	<table class="tablelist" id="tableData">
	         		<thead>
	         		 	<tr>
	        				...
	        				<td data-text="inv_code">物品唯一编号</td>
	        				<td data-text="inv_code">物品类型</td>
	        				<td data-text="inv_code">物品名称</td>
	        				<td data-text="ib_repay">应付款</td>
	        				<td data-text="ib_realPay">实付款</td>
	        				<td data-text="bs_statementNum">支付流水号</td>
	        				<!-- <td data-text="ib_operator">经办人</td>
	        				<td data-text="ib_operatTime">经办时间</td> -->
	        				<td data-text="ib_remark">备注</td>
	        				<td data-text="ib_createTime">创建时间</td>
	            		</tr>
	         		</thead>
	           		<tbody></tbody>
	        	</table>
