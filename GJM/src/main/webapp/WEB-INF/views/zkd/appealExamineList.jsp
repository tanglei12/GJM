...
<head>
    ...
    <link href="/resources/css/zkd/appealExamineList.css" rel="stylesheet" type="text/css">
    ...
    <script src="/resources/js/zkd/appealExamineList.js?v=<%=System.currentTimeMillis()%>"></script>
</head>
<body>
