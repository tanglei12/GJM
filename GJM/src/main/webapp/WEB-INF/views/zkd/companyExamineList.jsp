...
<head>
    ...
    <link href="/resources/css/zkd/companyExamineList.css" rel="stylesheet" type="text/css">
    ...
    <script src="/resources/js/zkd/companyExamineList.js?v=<%=System.currentTimeMillis()%>"></script>
</head>
<body>
