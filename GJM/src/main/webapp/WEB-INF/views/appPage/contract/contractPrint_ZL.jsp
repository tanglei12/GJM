...
<head>
	...
	<script src="/resources/js/appPage/contractPrint_ZL.js?v=<%=System.currentTimeMillis()%>"></script>
</head>
<body>
...
<div id="contractTGPrint" style="padding: 10px;background : url(/resources/image/appPage/contract/gjp_bg.png);">
	<div id="div1" class="" style="position: relative;text-align:center;margin: 0 auto;width: 100%; margin-bottom: 20px;">
		...
		<dl class="dl-list">
			...
			<dd>3、乙方租金支付日：</dd>
			<dd>从第2次支付日开始，月付须提前7天、季付和半年付须提前15天支付下次应付租金，乙方支付租金等款项具体约定时间见下表。如乙方逾期支付租金，每天须按月租金1%支付滞纳金给丙方。如乙方逾期超过5天，丙方有权单方面解除并终止本合同，乙方承担相应违约责任。</dd>
			<dd>
		...
		<dl class="dl-list">
			<dt>第七条&nbsp;&nbsp;清洁</dt>
			<dd>1、合同期内或期满，乙方退房给丙方时，须保证房屋清洁干净。</dd>
		...
		<dl class="dl-list">
			...
			<dd>2、新承租人继承乙方原有责任、权利和义务。为保障新承租人利益，须新承租人入住确认无人为损坏问题后，丙方第7天与乙方办理费用结算手续，扣除相关费用后，退还乙方剩余房租和保证金等。</dd>
		...
		<dl class="dl-list">
			...
			<dd>②合同期内的3-11月份，丙方验收房屋内装修\家具家电等无人为损坏，同意乙方办理退房手续，扣除乙方1个月租金和相关费用后，第7天退还乙方剩余款项。</dd>
			<dd>③合同期内，如丙方不同意乙方退房,乙方不得擅自退房。否则，乙方承担相应违约责任，丙方有权立即终止合同。</dd>
			<dd>2、合同期满的退房：</dd>
			<dd>①合同期满，乙方应及时交还房屋给丙方。如逾期交还，每天须按本合同日租金的1.5倍支付逾期天数租金直到交还房屋为止。</dd>
			<dd>②合同期满退房，丙方验收房屋内装修、家具家电等无人为损坏，丙方与乙方办理结算手续，扣除相关费用后，第7天退还乙方剩余款项。</dd>
		...
		<dl class="dl-list">
			...
			<dd>1、逾期未交房租，经丙方催告后，5天内仍不交纳租金的。</dd>
