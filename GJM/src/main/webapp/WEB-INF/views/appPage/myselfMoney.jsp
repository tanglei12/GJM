...
<link href="/resources/css/appPage/payMoneyList.css" rel="stylesheet" type="text/css">

<script src="/resources/js/jquery-2.0.0.min.js"></script><!-- jQuery插件 -->
<script src="/resources/mui/mui.min.js"></script><!-- 下拉刷新上拉更多 -->
<script src="/resources/js/common/common.js"></script>
<script src="/resources/js/appPage/payMoneyList.js"></script>
</head>
<body>
<div class="search">
	<div class="search-text"><input type="text" class="search-input" placeholder="房号/客户姓名/客户电话/金额" onkeyup="data(0)" /></div>
