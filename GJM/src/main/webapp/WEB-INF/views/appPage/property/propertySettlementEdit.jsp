...
<head>
    ...
    <!-- <link href="/resources/css/appPage/propertySettlementEdit.css" rel="stylesheet" type="text/css"> -->
    ...
    <script src="/resources/js/appPage/propertySettlementEdit.js?v=<%=System.currentTimeMillis()%>"></script>
</head>
<body>
<!-- 房源情况 -->
...
<main>
        ...
        <div class="content-main">
            ...
            <div class="content-item">
                <dl>
                    <dt>有线电视</dt>
                    <dd>
                        <input type="text" class="statement_xf error" name="statement_tv" data-mode="有线电视" value="0.0" readonly>
                        <i class="fa-angle-right"></i>
                    </dd>
                </dl>
            </div>
            ...
            <div class="content-item">
                <dl>
                    <dd>
                        <span style="display: block;width: 100%;text-align: right;">小计：<span class="error" id="statement_costs">0</span>&nbsp;元</span>
                    </dd>
                </dl>
            </div>
        </div>
    ...
    <div class="content" data-type="代理费">
        ...
        <div class="content-main">
            ...
            <div class="content-item">
                <dl>
                    <dd>
                        <span style="display: block;width: 100%;text-align: right;">总计：<span class="error" id="statement_agent">0</span>&nbsp;元</span>
                    </dd>
                </dl>
            </div>
        </div>
        ...
        <div class="content-main">
            <div class="content-item">
                <dl>
                    <dt>维修</dt>
                    <dd>
                        <input type="text" class="statement_wp error" name="statement_wx" data-mode="维修" value="0" readonly>
                        <i class="fa-angle-right"></i>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl>
                    <dt>保洁</dt>
                    <dd>
                        <input type="text" class="statement_wp error" name="statement_bj" data-mode="保洁" value="0" readonly>
                        <i class="fa-angle-right"></i>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl>
                    <dt>其他</dt>
                    <dd>
                        <input type="text" class="statement_wp error" name="statement_other2" data-mode="其他" value="0" readonly>
                        <i class="fa-angle-right"></i>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl>
                    <dd>
                        <span style="display: block;width: 100%;text-align: right;">小计：<span class="error" id="statement_goods">0</span>&nbsp;元</span>
                    </dd>
                </dl>
            </div>
        </div>
    ...
    <div class="content" data-type="违约金">
        ...
        <div class="content-main">
            ...
            <div class="content-item">
                <dl>
                    <dd>
                        <span style="display: block;width: 100%;text-align: right;">总计：<span class="error" id="statement_penalty">0</span>&nbsp;元</span>
                    </dd>
                </dl>
            </div>
        </div>
        ...
        <div class="content-main">
            <div class="content-item">
                <dl style="font-weight: bold;">
                    <dt>消费结算费用</dt>
                    <dd>
                        <input type="text" class="error" name="statement_1" data-type="1" value="0" readonly>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl style="font-weight: bold;">
                    <dt>物品结算费用</dt>
                    <dd>
                        <input type="text" class="error" name="statement_2" data-type="2" value="0" readonly>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl style="font-weight: bold;">
                    <dt>代理结算费用</dt>
                    <dd>
                        <input type="text" class="error" name="statement_3" data-type="3" value="0" readonly>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl style="font-weight: bold;">
                    <dt>违约金结算费用</dt>
                    <dd>
                        <input type="text" class="error" name="statement_4" data-type="4" value="0" readonly>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl style="font-weight: bold;">
                    <dt>其他结算费用</dt>
                    <dd>
                        <input type="text" class="error" name="statement_5" data-type="5" value="0" readonly>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl style="font-weight: bold;">
                    <dt>维修服务费</dt>
                    <dd>
                        <input type="text" class="error" name="statement_6" data-type="6" value="0" readonly>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl style="font-weight: bold;">
                    <dt>押金</dt>
                    <dd>
                        <input type="text" class="error" name="statement_7" data-type="7" value="0" readonly>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
    ...
    <div class="content" id="image-jsd-box" style="display: none;">
        <div class="content-head">
            <div class="content-item-title">结算单图片(限3张)</div>
            <div class="content-item-option">
                <button class="item-option-btn next-bg" name="imageJSD"><i class="fa-upload"></i>上传图片</button>
            </div>
        </div>
    ...
    <div class="content">
        <div class="content-main" style="border-top: 0;padding: 0;">
            <textarea name="statement_remarks" placeholder="备注" style="position: relative;width: 100%;padding: 10px;height: 100px;resize: none;font-size: 3.8vw;"></textarea>
        </div>
    </div>
    <!-- 其他 -->
    <div class="content">
        <div class="content-main">
            <div class="content-item">
                <dl>
                    <dt>结算人</dt>
                    <dd>
                        <input type="text" name="statement_balancer" placeholder="结算人" readonly>
                    </dd>
                </dl>
            </div>
            <div class="content-item">
                <dl>
                    ...
                    <dd>
                        <div class="date-angle">
                            <input type="text" name="calCostDate" placeholder="结算日期" readonly>
                        </div>
                    </dd>
                </dl>
            </div>
    ...
    <button class="submit" onclick="$.propertySettlement.save()">保存</button>
</main>
</body>
</html>