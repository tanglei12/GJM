...
<head>
    ...
    <link href="/resources/css/financeManage/orderBillList.css?v=<%=System.currentTimeMillis()%>" rel="stylesheet" type="text/css">
    ...
    <script src="/resources/js/financeManage/orderBillList.js<%--?v=<%=System.currentTimeMillis()%>--%>"></script>
</head>
<body>
</body>
</html>