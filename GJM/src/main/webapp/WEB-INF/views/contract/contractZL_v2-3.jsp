...
<script src="/resources/js/contractList/contractZL_v2-3.js?v=<%=System.currentTimeMillis()%>"></script>
	...
	<div id="contractTGPrint" style="width: 950px;margin: 2px auto;background : url(/resources/image/watermark.png);">
		<div id="div1" class="" style="position: relative;text-align:center;margin: 0 auto;width: 100%; margin-bottom: 20px;">
			...
			<div>
				...
				<p class="conInfo" style="text-indent:2em;">
					从第2次支付日开始，月付须提前7天、季付和半年付须提前15天支付下次应付租金，乙方支付租金等款项具体约定时间见下表。如乙方逾期支付租金，每天须按当期应付租金总额1%支付滞纳金给丙方。如乙方逾期超过10天，丙方有权单方面解除并终止本合同，乙方承担相应违约责任。
				</p>
			...
			<div>
				...
				<p class="conInfo">
					1、&nbsp;合同期内或期满，乙方退房给丙方时，须保证房屋清洁干净。如未做清洁或清洁不达标，则按3元/平米收取退房清洁费用（不低于80元/套）。
				</p>
				<p class="conInfo">
			...
			<div>
				...
				<p class="conInfo" style="text-indent:2em;">
					1、&nbsp;逾期未交房租，经丙方催告后，10天内仍不交纳租金的。
				</p>
				<p class="conInfo" style="text-indent:2em;">
					2、&nbsp;拖欠各项费用总额达1000元及以上(包括租金、宽带费、有线费、水电气费、物管费、服务费等)。
				</p>
				<p class="conInfo" style="text-indent:2em;">
					3、&nbsp;因乙方原因导致第三方分期月付逾期，经第三方或丙方催告后，仍不交纳租金的。乙方承担第三方相应违约金、当期租金每天1%的滞纳金和违约责任。
				</p>
				<p class="conInfo" style="text-indent:2em;">
					4、&nbsp;乙方申请第三方金融月付，因乙方原因导致合同提前解约的，乙方须支付金融公司月租金10%的违约金。
				</p>
				<p class="conInfo" style="text-indent:2em;">
					5、&nbsp;未经丙方书面同意或隐瞒丙方，擅自退房、擅自转租、擅自拆改变动房屋结构、擅自装修或擅自改变房屋租赁用途。
				</p>
				<p class="conInfo" style="text-indent:2em;">
					6、&nbsp;利用承租房屋进行违法活动或存放危险物品。
				</p>
				<p class="conInfo" style="text-indent:2em;">
					7、&nbsp;邻居或物业累计投诉3次及以上。
				</p>
				<p class="conInfo" style="text-indent:2em;">
					8、&nbsp;不依据本合同承担维修责任或支付维修费用，致使房屋装修或家具家电等设施设备严重损坏的，或在丙方提出的合理期限内仍未修复的。
				</p>
			</div>
			<div>
				<p class="conDigest_left">
