...
<script src="/resources/js/contractList/contractTG_v2-3.js?v=<%=System.currentTimeMillis()%>"></script>
	...
	<div id="contractTGPrint" style="width: 950px;margin: 2px auto;background : url(/resources/image/watermark.png);">
		<div id="div1" class="" style="position: relative;text-align:center;margin: 0 auto;width: 100%; margin-bottom: 20px;">
			...
			<div>
				...
				<p class="conInfo">
					7、&nbsp;首次代付租金日：每年度的免租期租金、管理费、包修费，乙方在每年度首次付租时扣除。<br>
				...
				<p class="conInfo">
					11、&nbsp;税费：甲方承担的房屋租赁税、房产税及政府规定的出租房屋征收的其他税费等，乙方协助办理。
				</p>
				<p class="conInfo">
