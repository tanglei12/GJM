...
<script src="/resources/js/contractList/contractTG_v2-2.js?v=1.1"></script>
		...
		<div id="div1" class="" style="position: relative;text-align:center;margin: 0 auto;width: 100%; margin-bottom: 20px;">
			...
			<div>
				<table>
					<tbody align="center">
						<tr width="100%">
							<td width="7%" height="20px"><label class="conDigest">甲&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;方:</label></td>
							<td width="34%" height="20px" class="tdLine">&nbsp;${contractVo.cc_name }</td>
							<td width="4%" height="20px"></td>
							<td width="7%" height="20px"><label class="conDigest">银&nbsp;&nbsp;行&nbsp;&nbsp;户&nbsp;&nbsp;名:</label></td>
							<td width="34%" height="20px" class="tdLine">&nbsp;${customers[0].customerBank.cbc_name }</td>
						</tr>
						<tr width="100%">
							<td width="7%" height="20px"><label class="conDigest">身&nbsp;份&nbsp;证&nbsp;号&nbsp;码:</label></td>
							<td width="34%" height="20px" class="tdLine">&nbsp;${contractVo.cc_cardNum }</td>
							<td width="4%" height="20px"></td>
							<td width="7%" height="20px"><label class="conDigest">银&nbsp;&nbsp;行&nbsp;&nbsp;卡&nbsp;&nbsp;号:</label></td>
							<td width="34%" height="20px" class="tdLine">&nbsp;${customers[0].customerBank.cbc_cardNum }</td>
						</tr>
						<tr width="100%">
							<td width="7%" height="20px"><label class="conDigest">联&nbsp;&nbsp;系&nbsp;&nbsp;电&nbsp;&nbsp;话:</label></td>
							<td width="34%" height="20px" class="tdLine">&nbsp;${contractVo.ccp_phone }</td>
							<td width="4%" height="20px"></td>
							<td width="7%" height="20px"><label class="conDigest">开&nbsp;&nbsp;户&nbsp;&nbsp;网&nbsp;&nbsp;点:</label></td>
							<td width="34%" height="20px" class="tdLine">&nbsp;${customers[0].customerBank.cbc_address }</td>
						</tr>
						<tr width="100%">
							<td width="7%" height="20px"><label class="conDigest">联&nbsp;&nbsp;络&nbsp;&nbsp;地&nbsp;&nbsp;址:</label></td>
							<td width="34%" height="20px" class="tdLine" clospan="4">&nbsp;${customers[0].contact_address }&nbsp;</td>
							<td width="4%" height="20px"></td>
							<td width="7%" height="20px"><label class="conDigest">Q&nbsp;Q&nbsp;&nbsp;或&nbsp;&nbsp;微&nbsp;信:</label></td>
							<td width="34%" height="20px" class="tdLine">&nbsp;${customers[0].cc_qq }</td>
						</tr>
						<tr width="100%">
							<td width="7%" height="20px"><label class="conDigest">乙&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;方:</label></td>
							<td width="34%" height="20px" style="text-align: left;"><label style="font-size:15px; font-family:'黑体 font-weight:bold;padding-left:5px;">&nbsp;重庆管家婆房地产经纪有限公司</label></td>
							<td width="4%" height="20px"></td>
							<td width="7%" height="20px"><label class="conDigest">营&nbsp;业&nbsp;执&nbsp;照&nbsp;号:</label></td>
							<td width="34%" height="20px" style="text-align: left;"><label style="font-size:15px; font-family:'黑体 font-weight:normal;padding-left:5px;">&nbsp;915001085540918999</label></td>
						</tr>
						<tr width="100%">
							<td width="7%" height="20px"><label class="conDigest">签&nbsp;&nbsp;约&nbsp;&nbsp;代&nbsp;&nbsp;表:</label></td>
							<td width="34%" height="20px" class="tdLine">&nbsp;${contractor.em_name }</td>
							<td width="4%" height="20px"></td>
							<td width="7%" height="20px"><label class="conDigest">联&nbsp;&nbsp;系&nbsp;&nbsp;电&nbsp;&nbsp;话:</label></td>
							<td width="34%" height="20px" class="tdLine">&nbsp;${contractor.em_phone } / 023-88067511 </td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div>
				...
				<p class="conInfo">
					1、&nbsp;房屋地址<label class="textUnderLine">&nbsp;${houseInfo.he_address }&nbsp;</label>，建筑面积<label class="textUnderLine">&nbsp;${houseInfo.hi_measure }&nbsp;</label>平米，户型是<label class="textUnderLine">&nbsp;${houseInfo.hi_houseS }&nbsp;</label>室<label class="textUnderLine">&nbsp;${houseInfo.hi_houseT }&nbsp;</label>厅<label class="textUnderLine">&nbsp;${houseInfo.hi_houseW }&nbsp;</label>卫。
				</p>
				<p class="conInfo">
			...
			<div>
				...
				<p class="conInfo">
					1、&nbsp;委托期限：<label class="textUnderLine">&nbsp;${startDateArray[0] }&nbsp;</label>年<label class="textUnderLine">&nbsp;${startDateArray[1] }&nbsp;</label>月<label class="textUnderLine">&nbsp;${startDateArray[2] }&nbsp;</label>日起至<label class="textUnderLine">&nbsp;${endDateArray[0] }&nbsp;</label>年<label class="textUnderLine">&nbsp;${endDateArray[1] }&nbsp;</label>月<label class="textUnderLine">&nbsp;${endDateArray[2] }&nbsp;</label>日止。
				</p>
				<p class="conInfo" style="text-indent: 2em;">
				...
				<p class="conInfo" style="display: flex;">2、&nbsp;<input type="hidden" value="${rentPlusStr }" id="rentPlusStr">租金（乙方代付）：<input type="hidden" value="${payStyle }" id="payStyle"><%--<label class="textUnderLine">&nbsp;${payStyle }&nbsp;</label>付，--%>
					<i class="fa fa-check-square-o" style="margin-top: 3px;" id="fu1"></i>月付<i class="fa fa-check-square-o" style="margin-left: 30px;margin-top: 3px;" id="fu2"></i>季付<i class="fa fa-check-square-o" style="margin-left: 30px;margin-top: 3px;" id="fu4"></i>半年付<i class="fa fa-check-square-o" style="margin-left: 30px;margin-top: 3px;" id="fu3"></i>年付
				</p>
				<p class="conInfo" style="text-indent: 2em;">符合条件的甲方若选择年付，即默认自愿申请与乙方合作的第三方办理房东年付服务，甲方可提前一次性收到当年度乙方代付租金，乙方协助甲方按年度申请，乙方按本合同约定租金还款给第三方。如当年度甲方未通过第三方审核，按本合同约定租金自动转为乙方季付给甲方。</p>
				<div style="text-indent: 2em;" id="rent">
					...
					<p class="conInfo">该租金是甲乙双方协商的最低出租月租金，如实际出租月租金超过该租金，超额租金分成比例如下。</p>
				</div>
				<p class="conInfo">
					3、&nbsp;超额租金分成：甲方<label class="textUnderLine">&nbsp;${contractBody.contractBody_RentRate_A }&nbsp;</label>％，乙方<label class="textUnderLine">&nbsp;${contractBody.contractBody_RentRate_B }&nbsp;</label>％。
				</p>
				<p class="conInfo">
				...
				<p class="conInfo">
					5、&nbsp;乙方管理费：<label class="textUnderLine" id="data_7">&nbsp;¥${contractBody.contractBody_Service }&nbsp;</label>元（大写<label class="textUnderLine" id="data_8">&nbsp;&nbsp;</label>整）。
				</p>
				<p class="conInfo">
					6、&nbsp;首次代付租金日：每年度的免租期租金，乙方在每年度首次付租时扣除。<br>
				...
				<p class="conInfo">
					7、&nbsp;乙方保证金<label class="textUnderLine" id="data_5">&nbsp;¥${contractBody.contractBody_Pay }&nbsp;</label>元（大写<label class="textUnderLine" id="data_6">&nbsp;&nbsp;</label>整）。
				</p>
				<p class="conInfo">
					8、&nbsp;乙方定金<label class="textUnderLine" id="data_1">&nbsp;¥${contractBody.contractBody_Depslit }&nbsp;</label>元（大写<label class="textUnderLine" id="data_2">&nbsp;&nbsp;</label>整），乙方首次代付租金时减除。
					<p class="conInfo" style="text-indent: 2em;">
				...
				<p class="conInfo">
					10、&nbsp;税费：甲方承担的房屋租赁税、房产税及政府规定的出租房屋征收的其他税费等，乙方协助办理。
				</p>
				<p class="conInfo">
			...
			<table style="margin-top: 60px;">
				<tr style="height: 60px;">
					...
					<td width="38%">重庆管家婆房地产经纪有限公司<img id="backgroudImg1" src="/resources/image/appPage/contractCachet3.png" style="width:227px; height:151px;position: absolute;left: 68%;z-index: 10;display: none;"></td>
				</tr>
				<tr style="height: 60px;">
					<td width="10%">日期：</td>
