...
<script src="/resources/js/contractList/contractTG_v2.js?v=1.1"></script>
	...
	<div id="contractTGPrint" style="width: 950px;margin: 2px auto;background : url(/resources/image/watermark.png);">
		<div id="div1" class="" style="position: relative;text-align:center;margin: 0 auto;width: 100%; margin-bottom: 20px;">
			...
			<div>
				...
				<p class="conInfo" style="display: flex;">2、&nbsp;<input type="hidden" value="${rentPlusStr }" id="rentPlusStr">租金（乙方代付）：<label class="textUnderLine">&nbsp;${payStyle }&nbsp;</label>付，</p>
			...
			<table style="margin-top: 60px;">
				<tr style="height: 60px;">
					...
					<td width="10%" style="text-align: right;">乙&nbsp;&nbsp;&nbsp;&nbsp;方：</td>
					<td width="10%">重庆管家婆房地产经纪有限公司<img id="backgroudImg1" src="/resources/image/appPage/contractCachet3.png" style="width:227px; height:151px;position: absolute;left: 68%;z-index: 10;display: none;"></td>
				</tr>
				<tr style="height: 60px;">
					<td width="10%">日期：</td>
					...
					<td width="10%" style="text-align: right;">签约代表：</td>
					<td width="40%">${contractor.em_name }</td>
				</tr>
			</table>
		</div>
	</div>
