...
<script src="/resources/js/intention/houseIntentionContentNew.js"></script><!-- 房源基本信息数据读取 -->
...
<body>
	...
	<input type="hidden" id="gj_emID" name="emcode" value="<%=AppUtil.getCookieEmployee(request).getEm_id()%>" />
...
<!-- 					<fieldset id="fieldset1s"> -->
					<div style="border: 1px dashed #ACCBE0;">
						...
						<div style="" class="houseDiv">
								...
								<dd style="width: 80%;">
									<div id="fangyuanyoushigenjin">
										...
										<label class="type-label" onclick="changeTypes(this)" style="padding: 0px 18px;">
											交通便利
											<i></i>
											<input type="checkbox" class="type-radio" name="hi_function" value="交通便利">
										</label>
										<label class="type-label" onclick="changeTypes(this)" style="padding: 0px 18px;">
											精装修
											<i></i>
											<input type="checkbox" class="type-radio" name="hi_function" value="精装修">
										</label>
										<label class="type-label" onclick="changeTypes(this)" style="padding: 0px 18px;">
											地铁站
											<i></i>
											<input type="checkbox" class="type-radio" name="hi_function" value="地铁站">
										</label>
										<label class="type-label" onclick="changeTypes(this)" style="padding: 0px 18px;">
											邻商圈
											<i></i>
											<input type="checkbox" class="type-radio" name="hi_function" value="邻商圈">
										</label>
										<%--<label class="type-label" onclick="changeTypes(this)" style="padding: 0px 18px;">
											采光好
											<i></i>
							...
							<hr>
 							<div class="col-md-12  modelAdd" style="width: 300px; margin: auto;height: 60px;">
 								<input class="btn btn-info pull-left" style=" width: 100px;" onclick="submit1(1)" type="button" value=" 提  交  " />
 								<input class="btn btn-info pull-left" style="margin-left: 77px; width: 100px;" onclick="updateDivCheck()" type="button" value=" 返  回  " />
 							</div>
						</div>
					</div>
 					<%--</fieldset>
					...
					<%--<dl>
							...
							<dl style="width: 100%;">
								...
								<dd style="width: 80%;">
									...
									<%--<div id="divys1" style="display: none;">
										...
										<input type="button" value="确  定" onclick="submitys(2)" style="background-color: #5bc0de; color: #fff; width: 60px; height: 30px; border-radius: 3px;">
									</div>--%>
								</dd>
							</dl>
							<hr>
							...
							<hr>
							<div class="col-md-12  modelAdd" style="width: 300px; margin: auto;height: 40px;">
								<input class="btn btn-info pull-left" style="width: 100px;" onclick="submit1(2)" type="button" value=" 提  交  "/>
								<input class="btn btn-info pull-left" style="margin-left: 77px; width: 100px;" onclick="updateDivCheck()" type="button" value=" 返  回  " />
							</div>
						</div>
					</div>
...
<!-- 					<fieldset id="fieldset3s" style=""> -->
					<div style="border: 1px dashed #ACCBE0;margin-top: 15px;">
						...
						<div style="" class="houseDiv">
							...
							<div class="col-md-12  modelAdd" style="width: 300px; margin: auto;height: 40px;">
                                <input class="btn btn-info pull-left" style="width: 100px;" onclick="submit1(3)" type="button" value=" 提  交  " />
                                <input class="btn btn-info pull-left" style="margin-left: 77px;width: 100px;" onclick="updateDivCheck()" type="button" value=" 返  回  " />
                            </div>
						</div>
					</div>
...
<!-- 											</label> -->
							...
							<div class="col-md-12  modelAdd" style="width: 300px; margin: auto;height: 40px;">
								<input class="btn btn-info pull-left" style="width: 100px;" onclick="submit1(4)" type="button" value=" 提  交  " />
								<input class="btn btn-info pull-left" style="margin-left: 77px;width: 100px;" onclick="updateDivCheck()" type="button" value=" 返  回  " />
							</div>
						</div>
					</div>
