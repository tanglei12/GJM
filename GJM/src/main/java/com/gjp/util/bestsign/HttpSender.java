...
public class HttpSender {
    ...
    public static Map<String, Object> getResponseString(String method, String url, String sendData, Map<String, Object> headers) throws IOException {
    ...
    public static Map<String, Object> getResponseBytes(String method, String url, String sendData, Map<String, Object> headers) throws IOException {
    ...
    private static class HttpRequester {
        public static Map<String, Object> request(String method, String url, Object sendData, Map<String, Object> headers) throws IOException {
