...
public class SignatureUtilsForPartner {
	...
	public static String encodeValue(String value){
		...
		return null;//Base64.getUrlEncoder().encodeToString(value.getBytes(Charset.forName("utf-8")));
	}
	/**
	 * 将参数值解码
	 * @param value
	...
	public static String decodeValue(String value){
		...
		return null; //new String(Base64.getUrlDecoder().decode(value.getBytes(Charset.forName("utf-8"))));
	}
	 /***
	  *MD5签名
	  * @param params
