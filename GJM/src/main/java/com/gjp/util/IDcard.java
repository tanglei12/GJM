...
public class IDcard {
    ...
    public static Map<String, Object> cardUtil(File file) {
        ...
        try {
            ...
            if (out.getBoolean("success")) {
                ...
                String nationality = out.getString("nationality"); // 民族
                String sex = out.getString("sex"); // 性别
    ...
    public static void cardUtilBack(File file) {
        String serviceURL = "http://dm-51.data.aliyun.com/rest/160601/ocr/ocr_idcard.json";
        // 对图像进行base64编码
        String imgBase64 = "";
        try {
