...
public class JiguangPush {
    ...
    private static String masterSecret = "0318aa962bd8421d49048c76";
    private static String appKey = "d2adc6ecf7734c409f04ef4e";

    public static void main(String[] args) throws APIConnectionException, APIRequestException {
        JPushClient jpushClient = new JPushClient(masterSecret, appKey);
        TagAliasResult result = jpushClient.getDeviceTagAlias("13065ffa4e3631e7951");
        JiguangPush jiguangPush = new JiguangPush();
        jiguangPush.jiguangPush(result.alias, "哈哈哈");
    }
